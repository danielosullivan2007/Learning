# -*- coding: utf-8 -*-
"""
Created on Wed Sep 06 08:00:42 2017
...
indir = 'C:\\Users\\useradmin\\Desktop\\Learning\\Kaggle\\'
...
def drop_features(df):
    return df.drop(['Ticket', u'Name', u'Embarked'], axis =1)
...
output.to_csv(indir+'titanic-predictions.csv',index =False)
output.head()
